...
function getNearbySuburbs(city: string): string[] {
  ...
  // Use a Set to ensure unique suburbs
  ...
  for (const region of Object.values(MELBOURNE_REGIONS)) {
    ...
    if (council) {
      council.key_suburbs
        ...
        .slice(0, 3)
        .forEach(suburb => nearbySuburbsSet.add(suburb));
    }
  }

  return Array.from(nearbySuburbsSet);
}
  ...
  return (
    ...
    <div className="absolute inset-0">
      ...
      <Image
        ...
        priority
      />
      {/* Removed gradient overlay for a brighter hero */}
    </div>
            ...
            <div className="flex flex-col pt-36 pb-32 md:pb-0 md:pt-32">
              {/* Text content */}
               <div className="max-w-2xl text-gray-900">
                ...
                {/* Mobile only translucent card for text content */}
