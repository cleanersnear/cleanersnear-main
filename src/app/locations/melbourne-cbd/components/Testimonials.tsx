...
const allReviews: Review[] = [
  {
    ...
    initials: 'ST',
    quote:
      'Absolutely amazing service! Got my full bond back without any issues. The team was professional and thorough. Highly recommend in Melbourne CBD!',
    rating: 5,
    locationLabel: 'Melbourne CBD Resident',
  },
  {
    name: 'Michael C.',
    initials: 'MC',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
            What Our Melbourne CBD Clients Say
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Trusted by hundreds of satisfied customers across Melbourne CBD and surrounding areas
          </p>
        </div>
        ...
        <div className="hidden md:block">
          <div className="max-w-7xl mx-auto relative mb-12">
            ...
            >
              <svg className="w-6 h-6 text-[#1E3D8F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
