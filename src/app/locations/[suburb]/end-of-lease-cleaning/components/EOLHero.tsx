    ...
    <section className="relative min-h-[500px] md:min-h-[400px] py-12 md:py-16">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt={`End of Lease Cleaning ${capitalizedSuburb}`}
          fill
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 md:mb-6">
            End of Lease Cleaning {capitalizedSuburb}<br />
            <span className="text-3xl md:text-4xl font-medium">Local Bond Cleaning Experts</span>
          </h1>
          
          <p className="text-xl text-white/90 mb-6 md:mb-8 max-w-2xl">
            Get your full bond back with our professional end of lease cleaning service in {capitalizedSuburb}. 
            Trusted by local real estate agents and property managers.
          </p>
