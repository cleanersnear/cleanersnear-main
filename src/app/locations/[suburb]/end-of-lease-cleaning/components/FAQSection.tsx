  ...
  const faqs = [
    {
      ...
      answer: `Our end of lease cleaning in ${capitalizedSuburb} includes complete kitchen deep clean, bathroom sanitization, inside all appliances, window cleaning, floor mopping & vacuuming, cabinet cleaning, light fixtures, baseboards, and door & frame cleaning. Everything needed to meet real estate standards.`
    },
    {
    ...
    },
    {
      ...
      answer: `End of lease cleaning in ${capitalizedSuburb} starts from $205 for studio apartments, $255 for 1 bedroom, $310 for 2 bedrooms, $450 for 3 bedrooms, and $625 for 4 bedrooms. All prices include our bond back guarantee and professional equipment.`
    },
    {
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Everything you need to know about our end of lease cleaning services in {capitalizedSuburb}
            </p>
          ...
          <div className="md:pl-8">
            <div className="sticky top-8">
              <h2 className="mb:text-center text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
                Book Your End of Lease<br />Cleaning in {capitalizedSuburb}
              </h2>
              <p className="text-gray-600 mb-8">
                Find trusted bond cleaning specialists in {capitalizedSuburb} with our bond back guarantee
              </p>
