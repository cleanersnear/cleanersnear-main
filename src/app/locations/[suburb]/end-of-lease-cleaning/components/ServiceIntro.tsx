...
type ServiceCategory = 'popular' | 'other'

export default function ServiceIntro({ service, suburb }: ServiceIntroProps) {
          ...
          <div className="lg:col-span-2 hidden md:block">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-3xl font-bold text-[#1E3D8F] mb-6">
                {capitalizedSuburb}&apos;s Most Trusted End of Lease Cleaning Service
              </h2>
              <p className="text-gray-600 mb-8">
                Moving out in {capitalizedSuburb}? Let us handle the cleaning while you focus on your move. Our end of lease cleaning service is designed to meet and exceed real estate agents&apos; expectations, ensuring you get your bond back.
              </p>
