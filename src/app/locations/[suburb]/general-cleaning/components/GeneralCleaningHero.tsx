...
export default function GeneralCleaningHero({ suburb = 'melbourne' }: GeneralCleaningHeroProps) {
    ...
    <section className="relative min-h-[500px] md:min-h-[400px] py-12 md:py-16">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt={`General Cleaning ${capitalizedSuburb}`}
          fill
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 md:mb-6">
            ...
            <span className="text-3xl md:text-4xl font-medium">{capitalizedSuburb}&apos;s Trusted Service</span>
          </h1>
          
          <p className="text-xl text-white/90 mb-6 md:mb-8 max-w-2xl">
            Experience the difference with our professional house cleaning service in {capitalizedSuburb}. 
