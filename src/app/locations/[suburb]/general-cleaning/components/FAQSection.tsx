...
export default function FAQSection({ locationData }: FAQSectionProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `General cleaning is perfect for weekly, fortnightly, or monthly maintenance in ${capitalizedSuburb}. The frequency depends on your lifestyle and preferences. We can work with you to create a schedule that keeps your home consistently clean.`
    },
    {
    ...
    },
    {
      ...
      answer: `General cleaning in ${capitalizedSuburb} starts from $92 for 2 hours, then $38/hour thereafter. This provides excellent value for regular maintenance cleaning. Get an instant quote when you book online based on your home size and requirements.`
    },
    {
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Everything you need to know about our general cleaning services in {capitalizedSuburb}
            </p>
          ...
          <div className="md:pl-8">
            <div className="sticky top-8">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
                Book Your General<br />Cleaning in {capitalizedSuburb}
              </h2>
              <p className="text-gray-600 mb-8">
                Find trusted cleaners in {capitalizedSuburb} for professional general cleaning service
              </p>
