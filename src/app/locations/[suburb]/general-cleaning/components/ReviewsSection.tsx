  ...
  const reviews = [
    {
      ...
      rating: 5,
      review: `General cleaning service in ${capitalizedSuburb} has been fantastic! They handle all the essential cleaning tasks and my home always looks great. Professional and reliable service.`,
      date: "1 week ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Love the general cleaning service in ${capitalizedSuburb}. They're thorough with the basics - dusting, vacuuming, kitchen and bathroom cleaning. Perfect for regular maintenance!`,
      date: "2 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `General cleaning in ${capitalizedSuburb} covers everything I need for home maintenance. They're consistent, professional, and always leave my place spotless. Highly recommended!`,
      date: "3 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Perfect general cleaning service in ${capitalizedSuburb}! They handle all the standard cleaning tasks efficiently. Great value and excellent quality. Will definitely book again.`,
      date: "4 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `General cleaning in ${capitalizedSuburb} is exactly what I needed. They take care of all the essential cleaning tasks and my home stays consistently clean. Very satisfied!`,
      date: "5 weeks ago",
