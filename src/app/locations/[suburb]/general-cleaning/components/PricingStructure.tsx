...
const PRICING_PLANS = [
  {
    ...
    description: "Perfect for busy households who want consistent cleanliness",
    price: "From $92",
    duration: "2 hours minimum",
    hourlyRate: "$38/hour thereafter",
    features: [
    ...
    popular: true,
    note: "Best value for regular maintenance"
  },
  {
    name: "Fortnightly Regular Cleaning",
    description: "Ideal for smaller households or those who prefer less frequent service",
    price: "From $130",
    duration: "3 hours minimum", 
    hourlyRate: "$38/hour thereafter",
    features: [
      "Same cleaner every fortnight",
      "Flexible scheduling",
      "General cleaning supplies included",
      "100% satisfaction guarantee"
    ],
    popular: false,
    note: "Perfect for lighter maintenance needs"
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            No hidden fees, no surprises. Choose the general cleaning schedule that works best for your {locationData.name} home and budget.
          </p>
        </div>
          ...
          {PRICING_PLANS.map((plan) => (
            ...
            >
              ...
              <div className={`p-6 lg:p-8 ${plan.popular ? 'pt-12' : ''}`}>
                ...
                <Link href={`/book?selectedServices=Regular%20Cleaning&frequency=${encodeURIComponent(plan.name.split(' ')[0])}&location=${encodeURIComponent(locationData.name)}`}>
                  <Button 
                    size="lg" 
                    className={`w-full ${
                      plan.popular 
