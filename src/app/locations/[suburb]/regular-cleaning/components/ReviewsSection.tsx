  ...
  const reviews = [
    {
      ...
      rating: 5,
      review: `I've been using their weekly regular cleaning in ${capitalizedSuburb} for 6 months now. Same amazing cleaner every time who knows my home perfectly. So reliable and thorough!`,
      date: "1 week ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Fortnightly cleaning in ${capitalizedSuburb} has been a game-changer for our busy family. The consistency and attention to detail is outstanding. Highly recommend!`,
      date: "2 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Started with regular cleaning in ${capitalizedSuburb} 3 months ago and couldn't be happier. My cleaner is fantastic and my home always looks spotless. Worth every penny!`,
      date: "3 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Amazing regular cleaning service in ${capitalizedSuburb}! They're flexible with scheduling and always accommodate my changing needs. The quality is consistently excellent.`,
      date: "4 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Love the weekly cleaning service in ${capitalizedSuburb}. My cleaner is so professional and friendly. She knows exactly how I like things done. Couldn't ask for better!`,
      date: "5 weeks ago",
