...
export default function FAQSection({ locationData }: FAQSectionProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `Our regular cleaning includes dusting, vacuuming, mopping, bathroom cleaning, kitchen cleaning, tidying, bed making, and basic organization. We also clean appliances like fridges and ovens as needed. All services are performed by our professional ${capitalizedSuburb} cleaners.`
    },
    {
      question: "How much does regular cleaning cost?",
      answer: `Regular cleaning in ${capitalizedSuburb} starts from $92 for 2 hours, then $38/hour thereafter. The total cost depends on your home size and specific requirements. Get an instant quote when you book online.`
    },
    {
      question: "Can I customize my regular cleaning schedule?",
      answer: `Absolutely! You can choose weekly or fortnightly frequency, select your preferred day and time, and specify any additional tasks. We'll create a cleaning plan tailored to your ${capitalizedSuburb} home needs.`
    },
    {
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Everything you need to know about our regular cleaning services in {capitalizedSuburb}
            </p>
          ...
          <div className="md:pl-8">
            <div className="sticky top-8">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
                Book Your Regular<br />Cleaning in {capitalizedSuburb}
              </h2>
              <p className="text-gray-600 mb-8">
                Find trusted cleaners in {capitalizedSuburb} for professional regular cleaning service
              </p>
