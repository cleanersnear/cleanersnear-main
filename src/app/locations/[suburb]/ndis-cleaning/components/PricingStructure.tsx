...
const PRICING_PLANS = [
  {
    ...
    description: "Perfect for NDIS participants who need consistent weekly support",
    price: "From $112",
    duration: "2 hours minimum",
    hourlyRate: "$56/hour thereafter",
    features: [
    ...
    popular: true,
    note: "Best value for regular support"
  },
  {
    name: "Fortnightly NDIS Cleaning",
    description: "Ideal for NDIS participants who prefer less frequent service",
    price: "From $168",
    ...
    features: [
      ...
      "Flexible scheduling",
      "NDIS cleaning supplies included",
      "100% satisfaction guarantee"
    ],
    popular: false,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            No hidden fees, no surprises. Choose the NDIS cleaning schedule that works best for your {capitalizeFirstLetter(locationData.name)} support needs and budget.
          </p>
        </div>
          ...
          {PRICING_PLANS.map((plan) => (
            ...
            >
              ...
              <div className={`p-6 lg:p-8 ${plan.popular ? 'pt-12' : ''}`}>
                ...
                <Link href={`/book?selectedServices=NDIS%20Cleaning&location=${encodeURIComponent(locationData.name)}`}>
                  <Button 
                    size="lg" 
                    className={`w-full ${
                      plan.popular 
