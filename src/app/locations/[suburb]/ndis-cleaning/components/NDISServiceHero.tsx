...
interface NDISServiceHeroProps {
  locationData: LocationData;
  suburbSlug: string;
}

export default function NDISServiceHero({ locationData, suburbSlug }: NDISServiceHeroProps) {
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                Compassionate, reliable house cleaning for NDIS participants in {capitalizeFirstLetter(locationData.name)}. Flexible weekly or fortnightly schedules with experienced, background-checked cleaners who understand your needs.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link href={`/book?selectedServices=NDIS%20Cleaning&location=${encodeURIComponent(locationData.name)}`} className="w-full sm:w-auto">
                <Button 
                  size="lg" 
                ...
                >
                  Book NDIS Cleaning in {capitalizeFirstLetter(locationData.name)}
                </Button>
              </Link>
          ...
          <div className="relative">
            <div className="relative h-[350px] sm:h-[400px] lg:h-[500px] xl:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt={`Professional NDIS cleaning service in ${capitalizeFirstLetter(locationData.name)}`}
                fill
