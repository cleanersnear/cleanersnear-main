...
const PRICING_PLANS = [
  {
    ...
    hourlyRate: "Flexible scheduling",
    features: [
  ...
  },
  {
    ...
    hourlyRate: "Discounts by frequency",
    features: [
    ...
    popular: false,
    note: "Best value for ongoing needs"
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            No hidden fees, no surprises. Choose the commercial cleaning service that works best for your {capitalizeFirstLetter(locationData.name)} business needs and budget.
          </p>
        </div>
