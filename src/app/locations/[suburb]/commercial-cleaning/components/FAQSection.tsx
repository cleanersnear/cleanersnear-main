...
export default function FAQSection({ suburb = 'Melbourne' }: FAQSectionProps) {
  ...
  const faqs = [
    {
      ...
      answer: `Commercial cleaning in ${capitalizedSuburb} encompasses a broad range of services tailored to meet the unique needs of different businesses. These can include general cleaning (dusting, vacuuming, sanitising surfaces, emptying bins, and mopping floors) to maintain a clean and welcoming environment.`
    },
    {
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="md:pl-8">
            <div className="sticky top-8">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
                Schedule Your Commercial<br />Cleaning in {capitalizedSuburb} Today
              </h2>
              <p className="text-gray-600 mb-8">
