...
export default function CommercialCleaningHero({ suburb = 'Melbourne' }: CommercialCleaningHeroProps) {
    ...
    <section className="relative min-h-[500px] md:min-h-[400px] py-12 md:py-16">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt={`Commercial Cleaning ${capitalizedSuburb}`}
          fill
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 md:mb-6">
            Commercial Cleaning {capitalizedSuburb}<br />
          ...
          <p className="text-xl text-white/90 mb-6 md:mb-8 max-w-2xl">
            Transform your workspace in {capitalizedSuburb} with our comprehensive commercial cleaning service. 
