...
export function CommercialCleaningHero({ locationData, suburbSlug }: CommercialCleaningHeroProps) {
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                Professional cleaning for offices, retail spaces, and commercial properties in {capitalizeFirstLetter(locationData.name)}. Flexible schedules, experienced teams, and reliable service to keep your business spotless and professional.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-sm sm:text-base text-gray-700 font-medium">Fully Insured & Bonded</span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link href={`/book?selectedServices=Commercial%20Cleaning&location=${encodeURIComponent(locationData.name)}`}>
                <Button 
                  size="lg" 
                ...
                >
                  Book Commercial Cleaning in {capitalizeFirstLetter(locationData.name)}
                </Button>
              </Link>
          ...
          <div className="relative">
            <div className="relative h-[350px] sm:h-[400px] lg:h-[500px] xl:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt={`Professional commercial cleaning service in ${capitalizeFirstLetter(locationData.name)}`}
                fill
