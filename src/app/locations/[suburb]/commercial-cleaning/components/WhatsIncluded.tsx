        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
          <div>
            ...
            <p className="mt-4 text-gray-600">
              Our comprehensive commercial cleaning covers all office spaces, restrooms, common areas, and workstations. Professional cleaning that maintains a clean, healthy, and productive work environment for your business.
            </p>
            <div className="mt-6">
