...
export async function generateMetadata({ 
  ...
  const locationKeywords = [
    // Near me variations
    `spring cleaning near me ${suburb.toLowerCase()}`,
    `deep cleaning near me ${suburb.toLowerCase()}`,
    `deep house cleaning near me ${suburb.toLowerCase()}`,
    `spring house cleaning near me ${suburb.toLowerCase()}`,
    ...
    `spring cleaning in ${suburb.toLowerCase()}`,
    `deep cleaning in ${suburb.toLowerCase()}`,
    `spring cleaning ${suburb.toLowerCase()}`,
    `deep cleaning ${suburb.toLowerCase()}`,
    `deep house cleaning ${suburb.toLowerCase()}`,
    `spring house cleaning ${suburb.toLowerCase()}`,
    ...
    `spring clean experts ${suburb.toLowerCase()}`,
    ...
    `spring cleaning near ${suburb.toLowerCase()}`,
    ...
    `local spring cleaners ${suburb.toLowerCase()}`,
    `local cleaning services ${suburb.toLowerCase()}`,
    `${suburb.toLowerCase()} deep cleaning service`,
    `${suburb.toLowerCase()} spring cleaning service`,
    ...
    `spring cleaning services ${suburb.toLowerCase()}`,
    `affordable spring cleaning ${suburb.toLowerCase()}`,
    ...
    `best spring cleaners ${suburb.toLowerCase()}`,
    `professional spring cleaners ${suburb.toLowerCase()}`,
  ...
  return {
    title: `Spring & Deep Cleaning Services ${capitalizedSuburb} | From $53.07/hr | Professional Clean`,
    description: `Expert spring and deep cleaning services in ${capitalizedSuburb} starting from $53.07/hr. Professional equipment & eco-friendly products. Thorough sanitization of all surfaces. Book online or call +61450124086 for a quote!`,
    ...
    openGraph: {
      title: `${capitalizedSuburb} Spring & Deep Cleaning Services | From $53.07/hr | Book Online`,
      description: `Transform your home with our professional spring and deep cleaning service in ${capitalizedSuburb}. Thorough sanitization, detailed cleaning of all surfaces, and intensive cleaning using professional-grade equipment. Book your spring clean today!`,
      url: `https://www.cleaningprofessionals.com.au/locations/${slugSuburb}/spring-cleaning/`,
    ...
    twitter: {
      ...
      title: `${capitalizedSuburb} Spring & Deep Cleaning Services | From $53.07/hr | Book Online`,
      description: `Expert spring and deep cleaning in ${capitalizedSuburb}. | Professional equipment | Thorough sanitization | Detailed cleaning | Eco-friendly products | Book now!`,
      images: ['/images/deep-cleaning-melbourne.jpg'],
    },
    alternates: {
      canonical: `/locations/${slugSuburb}/spring-cleaning/`,
    },
    authors: [{ name: 'Cleaning Professionals Melbourne' }],
    generator: 'Next.js',
    applicationName: `${capitalizedSuburb} Spring & Deep Cleaning Services`,
    ...
    category: 'Spring & Deep Cleaning Services',
    other: {
      'geo.region': 'AU-VIC',
