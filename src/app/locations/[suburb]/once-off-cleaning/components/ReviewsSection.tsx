  ...
  const reviews = [
    {
      ...
      rating: 5,
      review: `Booked a once-off deep clean in ${capitalizedSuburb} for my move-out and wow! They cleaned every corner, inside appliances, and even the windows. My bond was returned in full!`,
      date: "1 week ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Needed a spring clean in ${capitalizedSuburb} after renovations and they delivered beyond expectations. Deep cleaned everything including carpets and detailed scrubbing. Amazing work!`,
      date: "2 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Once-off deep clean in ${capitalizedSuburb} was exactly what I needed. They were thorough, professional, and left my home sparkling. Highly recommend for special occasions!`,
      date: "3 weeks ago",
