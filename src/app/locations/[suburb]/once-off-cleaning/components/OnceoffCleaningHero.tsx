...
interface OnceoffCleaningHeroProps {
  locationData: LocationData;
  suburbSlug: string;
}

export function OnceoffCleaningHero({ locationData, suburbSlug }: OnceoffCleaningHeroProps) {
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                Professional deep cleaning in {capitalizeFirstLetter(locationData.name)} for move-in/out, spring cleans, or post-renovation. Thorough cleaning that reaches every corner with our experienced team and quality guarantee.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="relative h-[350px] sm:h-[400px] lg:h-[500px] xl:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt={`Professional once-off deep cleaning service in ${capitalizeFirstLetter(locationData.name)}`}
                fill
