      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            No hidden fees, no surprises. Choose the once-off deep cleaning package that works best for your {capitalizeFirstLetter(locationData.name)} home and requirements.
          </p>
        </div>
