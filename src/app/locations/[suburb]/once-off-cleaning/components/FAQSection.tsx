...
export default function FAQSection({ locationData }: FAQSectionProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `Deep cleaning typically takes 4-8 hours depending on home size and requirements. We start with a 4-hour minimum for standard homes in ${capitalizedSuburb} and add time as needed for larger properties or additional services.`
    },
    {
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Everything you need to know about our once-off deep cleaning services in {capitalizedSuburb}
            </p>
          ...
          <div className="md:pl-8">
            <div className="sticky top-8">
              <h2 className="mb:text-center text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
                Book Your Deep, Once-off<br />Cleaning in {capitalizedSuburb}
              </h2>
              <p className="text-gray-600 mb-8">
                Find trusted cleaners in {capitalizedSuburb} for professional once-off deep cleaning service
              </p>
