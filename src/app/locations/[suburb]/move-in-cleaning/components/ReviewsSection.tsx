  ...
  const reviews = [
    {
      ...
      rating: 5,
      review: `Booked move-in cleaning in ${capitalizedSuburb} and couldn't be happier! They cleaned every corner, inside appliances, and even the windows. My new home was spotless when I arrived!`,
      date: "1 week ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Move-in cleaning service in ${capitalizedSuburb} was exceptional! They handled everything from deep cleaning to sanitizing. Perfect way to start fresh in my new home.`,
      date: "2 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Amazing move-in cleaning in ${capitalizedSuburb}! They were thorough, professional, and left my new place sparkling. Highly recommend for anyone moving into a new home!`,
      date: "3 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Incredible move-in cleaning service in ${capitalizedSuburb}! They cleaned areas I didn't even think about. My new home felt brand new when I moved in.`,
      date: "4 weeks ago",
    ...
    },
    {
      ...
      location: capitalizedSuburb,
      rating: 5,
      review: `Booked their premium move-in cleaning package in ${capitalizedSuburb} and it was worth every dollar. They cleaned inside every appliance and even the light fixtures. Perfect start to my new home!`,
      date: "5 weeks ago",
