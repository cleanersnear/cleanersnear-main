...
export default function MoveInCleaningHero({ suburb = 'melbourne' }: MoveInCleaningHeroProps) {
    ...
    <section className="relative min-h-[500px] md:min-h-[400px] py-12 md:py-16">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt={`Move In & Out Cleaning ${capitalizedSuburb}`}
          fill
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            Cleaning Services {capitalizedSuburb}
          </h1>
          
          <p className="text-lg text-white/90 mb-8 max-w-2xl">
            Expert cleaning services for your moving day in {capitalizedSuburb}. Choose from our Moving In service starting at $48.50/hr or Moving Out service from $63.05/hr. Our professional team ensures your space is perfectly clean for the next chapter.
          </p>
