...
interface MoveInCleaningHeroProps {
  locationData: LocationData;
  suburbSlug: string;
}

export function MoveInCleaningHero({ locationData, suburbSlug }: MoveInCleaningHeroProps) {
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                Start fresh in your new {capitalizeFirstLetter(locationData.name)} home with our professional move-in cleaning service. Comprehensive cleaning that ensures every corner is spotless before you move in your belongings.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-sm sm:text-base text-gray-700 font-medium">Comprehensive Clean</span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link href={`/book?selectedServices=Once-Off%20Cleaning&location=${encodeURIComponent(locationData.name)}`}>
                ...
                >
                  Book Move In Cleaning in {capitalizeFirstLetter(locationData.name)}
                </Button>
              </Link>
          ...
          <div className="relative">
            <div className="relative h-[350px] sm:h-[400px] lg:h-[500px] xl:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/move-in-cleaning.png"
                alt={`Professional move-in cleaning service in ${capitalizeFirstLetter(locationData.name)}`}
                fill
