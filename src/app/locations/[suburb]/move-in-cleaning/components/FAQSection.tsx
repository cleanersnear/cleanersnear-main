...
export default function FAQSection({ locationData }: FAQSectionProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `Move-in cleaning typically takes 3-6 hours depending on home size and condition. We start with a 3-hour minimum for standard homes in ${capitalizedSuburb} and add time as needed for larger properties.`
    },
    {
      question: "What's included in move-in cleaning?",
      answer: `Our move-in cleaning includes comprehensive dusting, floor cleaning, inside appliances, window cleaning, light fixtures, cabinets, baseboards, and detailed bathroom/kitchen cleaning to ensure your new ${capitalizedSuburb} home is move-in ready.`
    },
    {
      question: "How much does move-in cleaning cost?",
      answer: `Move-in cleaning in ${capitalizedSuburb} starts from $161 for 3 hours, then $45/hour thereafter. Premium packages with additional services start from $296. Get an instant quote when you book online based on your home size and requirements.`
    },
    {
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Everything you need to know about our move-in cleaning services in {capitalizedSuburb}
            </p>
          ...
          <div className="md:pl-8">
            <div className="sticky top-8">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
                Book Your Move-In<br />Cleaning in {capitalizedSuburb}
              </h2>
              <p className="text-gray-600 mb-8">
                Find trusted cleaners in {capitalizedSuburb} for professional move-in cleaning service
              </p>
