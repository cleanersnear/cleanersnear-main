...
interface MobileWhatsIncludedProps {
  suburb: string
}

export default function MobileWhatsIncluded({ suburb }: MobileWhatsIncludedProps) {
    ...
    <section className="md:hidden py-8 pb-4 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold text-[#1E3D8F] mb-6 text-center">
          What&apos;s Included in Carpet Cleaning in {suburb}
        </h2>
