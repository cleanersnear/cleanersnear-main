...
export function AirbnbCleaningHero({ locationData, suburbSlug }: AirbnbCleaningHeroProps) {
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="space-y-3 lg:space-y-4">
              <div className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 bg-blue-100 text-[#1E3D8F] rounded-full text-xs sm:text-sm font-medium">
                ...
                Fast turnovers with hotel-standard presentation
              </div>
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                Fast turnovers with hotel-standard presentation for your {capitalizeFirstLetter(locationData.name)} short-term rental. Professional cleaning service with linen change, restocking, and guest-ready presentation every time.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-sm sm:text-base text-gray-700 font-medium">Fast Turnovers</span>
              </div>
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-sm sm:text-base text-gray-700 font-medium">Hotel Standard</span>
              </div>
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-sm sm:text-base text-gray-700 font-medium">Linen Change</span>
              </div>
            </div>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link href={`/book?selectedServices=Airbnb%20Cleaning&location=${encodeURIComponent(locationData.name)}`}>
                <Button 
                  size="lg" 
                ...
                >
                  Book Airbnb Cleaning in {capitalizeFirstLetter(locationData.name)}
                </Button>
              </Link>
          ...
          <div className="relative">
            <div className="relative h-[350px] sm:h-[400px] lg:h-[500px] xl:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/images/airbnb-cleaning-melbourne.png"
                alt={`Professional Airbnb cleaning service in ${capitalizeFirstLetter(locationData.name)}`}
                fill
