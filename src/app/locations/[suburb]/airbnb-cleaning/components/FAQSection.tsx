...
export default function FAQSection({ locationData }: FAQSectionProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `We specialize in fast turnovers in ${capitalizedSuburb}! Our regular cleaning typically takes 2-3 hours depending on property size. We can often accommodate same-day bookings and work around your guest check-in/out schedules.`
    },
    {
      question: "What's included in Airbnb cleaning service?",
      answer: `Our Airbnb cleaning in ${capitalizedSuburb} includes complete linen change, bathroom deep clean, kitchen sanitization, floor cleaning, surface dusting, amenity restocking, trash removal, and guest-ready presentation with quality inspection.`
    },
    {
      question: "How much does Airbnb cleaning cost?",
      answer: `Regular Airbnb cleaning in ${capitalizedSuburb} starts from $118 for 2 hours, then $45/hour thereafter. Once-off deep cleaning starts from $198 for 3 hours, then $50/hour thereafter. Pricing depends on property size and specific requirements.`
    },
    {
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">
              Everything you need to know about our Airbnb cleaning services in {capitalizedSuburb}
            </p>
          ...
          <div className="md:pl-8">
            <div className="sticky top-8">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
                Book Your Airbnb<br />Cleaning in {capitalizedSuburb}
              </h2>
              <p className="text-gray-600 mb-8">
                Find trusted Airbnb cleaners in {capitalizedSuburb} for professional turnover cleaning service
              </p>
