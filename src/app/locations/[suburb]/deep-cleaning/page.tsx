...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `Deep Cleaning ${capitalizedSuburb} | Professional Deep House Clean | Cleaning Professionals`,
    description: `Professional deep cleaning service in ${capitalizedSuburb}. Thorough cleaning for every corner of your home. Experienced cleaners with quality guarantee and same-day availability. Starting from $161 for 3 hours.`,
    keywords: [
      `deep cleaning ${capitalizedSuburb}`,
      `professional deep cleaning ${capitalizedSuburb}`, 
      `thorough house cleaning ${capitalizedSuburb}`,
      `deep clean ${capitalizedSuburb} $161`,
      `professional house cleaning ${capitalizedSuburb}`,
      `deep cleaning service ${capitalizedSuburb}`,
      `home deep cleaning ${capitalizedSuburb}`,
      `house deep cleaning ${capitalizedSuburb}`,
      `deep clean service ${capitalizedSuburb}`,
      `thorough cleaning ${capitalizedSuburb}`,
      `${capitalizedSuburb} deep cleaning company`,
      `trusted deep cleaners ${capitalizedSuburb}`,
      `insured deep cleaners ${capitalizedSuburb}`,
      `best deep cleaners ${capitalizedSuburb}`,
      `affordable deep cleaning ${capitalizedSuburb}`,
      `${capitalizedSuburb} deep cleaning near me`,
      `local deep cleaners ${capitalizedSuburb}`,
      `professional deep cleaners ${capitalizedSuburb}`,
      `reliable deep cleaning ${capitalizedSuburb}`,
      `spring cleaning ${capitalizedSuburb}`,
      `bond cleaning ${capitalizedSuburb}`
    ].join(", "),
    alternates: { 
      canonical: `https://www.cleaningprofessionals.com.au/locations/${resolvedParams.suburb}/deep-cleaning` 
    },
    robots: {
      index: true,
      follow: true,
    ...
    openGraph: {
      title: `Deep Cleaning ${capitalizedSuburb} | Professional Deep House Clean | Cleaning Professionals`,
      description: `Professional deep cleaning service in ${capitalizedSuburb}. Thorough cleaning for every corner of your home with experienced cleaners. Starting from $161 for 3 hours.`,
      url: `https://www.cleaningprofessionals.com.au/locations/${resolvedParams.suburb}/deep-cleaning`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `Professional Deep Cleaning Service in ${capitalizedSuburb}, Victoria`,
        },
      ],
    },
    twitter: {
      card: "summary_large_image",
      title: `Deep Cleaning ${capitalizedSuburb} | Professional Deep House Clean`,
      description: `Professional deep cleaning service in ${capitalizedSuburb} by Cleaning Professionals. Starting from $161 for 3 hours.`,
...
export default async function DeepCleaningPage({ params }: PageProps) {
  const resolvedParams = await params;
  const suburb = resolvedParams.suburb.replace(/-/g, ' ');
  ...
  const serviceSchema = {
    ...
    "@type": "Service",
    "@id": `https://www.cleaningprofessionals.com.au/locations/${resolvedParams.suburb}/deep-cleaning#service`,
    "name": `Deep Cleaning ${capitalizeFirstLetter(locationData.name)}`,
    "description": `Professional deep cleaning service in ${capitalizeFirstLetter(locationData.name)}. Thorough cleaning that reaches every corner of your home. Starting from $161 for 3 hours.`,
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", position: 4, name: "Deep Cleaning", item: `https://www.cleaningprofessionals.com.au/locations/${resolvedParams.suburb}/deep-cleaning` },
      ],
    },
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://www.cleaningprofessionals.com.au/locations/${resolvedParams.suburb}/deep-cleaning`
    }
  };
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Deep cleaning is more thorough than regular cleaning, focusing on areas often missed in routine maintenance. It includes inside appliances, detailed scrubbing, window cleaning, and deep sanitizing perfect for move-in/out or when you need extra thoroughness."
        }
      },
      {
        "@type": "Question",
        "name": `How long does a deep clean take in ${capitalizeFirstLetter(locationData.name)}?`,
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Deep cleaning typically takes 4-8 hours depending on home size and requirements. We start with a 3-hour minimum for standard homes and add time as needed for larger properties or additional services."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": `How much does deep cleaning cost in ${capitalizeFirstLetter(locationData.name)}?`,
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 4,
        "name": "Deep Cleaning",
        "item": `https://www.cleaningprofessionals.com.au/locations/${resolvedParams.suburb}/deep-cleaning`
      }
    ]
  };
  ...
  const localBusinessSchema = {
    ...
    "description": `Professional cleaning services in ${capitalizeFirstLetter(locationData.name)}, Victoria. Deep cleaning, move-in/out cleaning, and more.`,
    "address": {
      "@type": "PostalAddress",
  ...
  return (
    <MainLayout>
      <div className="mt-28">
        ...
        <DeepCleaningHero locationData={locationData} suburbSlug={resolvedParams.suburb} />
