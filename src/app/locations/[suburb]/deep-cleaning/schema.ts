export const getLocalBusinessSchema = (suburb: string) => {
  ...
  return {
    ...
    '@type': 'LocalBusiness',
    '@id': `https://cleaningprofessionals.com.au/locations/${suburb}/deep-cleaning`,
    name: `Cleaning Professionals ${capitalizedSuburb} - Deep Cleaning Services`,
    image: '/images/deep-cleaning-melbourne.jpg',
    description: `Professional deep cleaning service in ${capitalizedSuburb}. Specialized in thorough sanitization, detailed cleaning of all surfaces, and intensive cleaning using professional-grade equipment. Starting from $53.07/hour with minimum 3 hours booking.`,
    url: `https://cleaningprofessionals.com.au/locations/${suburb}/deep-cleaning`,
    ...
    hasOfferCatalog: {
      '@type': 'OfferCatalog',
      name: `Deep Cleaning Services in ${capitalizedSuburb}`,
      itemListElement: [
        {
          '@type': 'Offer',
          itemOffered: {
