    ...
    <section className="relative min-h-[500px] md:min-h-[400px] py-12 md:py-16">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt={`Deep Cleaning ${capitalizedSuburb}`}
          fill
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4 mb-6 md:mb-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full flex items-center">
              ...
              <span className="text-white text-sm font-medium">Expert Deep Clean Specialists</span>
            </div>
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full flex items-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 md:mb-6">
            Deep Cleaning {capitalizedSuburb}<br />
          ...
          <p className="text-xl text-white/90 mb-6 md:mb-8 max-w-2xl">
            Transform your space with our comprehensive deep cleaning service in {capitalizedSuburb}. 
          ...
          <div className="flex gap-4 mb-6 md:mb-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              <div className="text-white/80 text-sm mb-1">3 Hours Deep Clean</div>
            ...
            {/* Premium Deep Clean */}
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
              <div className="text-white/80 text-sm mb-1">6 Hours Deep Clean</div>
