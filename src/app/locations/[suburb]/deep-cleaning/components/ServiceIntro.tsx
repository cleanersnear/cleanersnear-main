        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 hidden md:block">
            <div className="prose prose-lg max-w-none">
              <h2 className="text-3xl font-bold text-[#1E3D8F] mb-6">
                Professional Deep Cleaning Services in Melbourne
              </h2>
              <p className="text-gray-600 mb-8">
                Transform your home with our comprehensive deep cleaning service. We go beyond standard cleaning to tackle built-up dirt, grime, and hidden areas that need special attention. Our professional team uses specialized equipment and techniques to ensure a thorough, detailed clean that revitalizes your living space.
              </p>
          ...
          <div className="lg:col-span-1 hidden md:block">
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-32">
              <h3 className="text-2xl font-bold mb-4">Book Your Deep Clean</h3>
