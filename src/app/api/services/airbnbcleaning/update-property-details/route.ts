...
export async function POST(request: NextRequest) {
  try {
    console.log('Next.js API route: Received update-property-details request')
    ...
    try {
      ...
      const response = await fetch(`${backendUrl}/api/services/airbnbcleaning/update-property-details`, {
        method: 'POST',
        headers: {
