...
export const metadata: Metadata = {
  title: 'End of Lease Cleaners Melbourne | From $289 | Bond Back Guarantee',
  description: 'Expert end of lease cleaning near me in Melbourne. Professional bond cleaners, competitive vacate cleaning cost. 100% bond back guaranteed or we\'ll re-clean for free! Book local cleaners for end of lease today.',
  keywords: 'end of lease cleaning melbourne, cleaners for end of lease, end of lease cleaning near me, bond cleaning melbourne, vacate cleaning, end of lease cleaning cost, end of lease cleaning price, end of lease carpet cleaning, bond back cleaning, end of tenancy cleaning, exit clean',
  robots: {
    index: true,
    follow: true,
    googleBot: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional End of Lease Cleaning Services Melbourne',
      },
    ],
    locale: 'en_AU',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Melbourne End of Lease Cleaners | Bond Back Guaranteed',
    description: 'Top-rated end of lease cleaning service in Melbourne. Fixed price vacate cleaning, professional bond cleaners. Get your bond back, guaranteed!',
  ...
  generator: 'Next.js',
  applicationName: 'Melbourne End of Lease Cleaning Services',
