...
export function EOLCleaningHero() {
          ...
          <div className="space-y-6 lg:space-y-8">
            <div className="space-y-3 lg:space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                Professional end of lease cleaning to help you get your bond back. REIV checklist compliant with bond back guarantee. From $205 for studio apartments.
              </p>
            </div>
