...
const SERVICES = [
  ...
  "Inside all appliances cleaning",
        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
          <div>
            ...
            <p className="mt-4 text-gray-600">
              Our comprehensive end of lease cleaning covers every surface, appliance, and corner to meet real estate standards. REIV checklist compliant with bond back guarantee to help you get your full bond returned.
            </p>
            <div className="mt-6">
