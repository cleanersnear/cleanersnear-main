...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Deep cleaning typically takes 4-8 hours depending on home size and requirements. We start with a 3-hour minimum for standard homes and add time as needed for larger properties or additional services."
    },
    {
    ...
    },
    {
      ...
      answer: "Deep cleaning starts from $161 for 3 hours, then $45/hour thereafter. Premium packages with additional services start from $296. Get an instant quote when you book online based on your home size and requirements."
    },
    {
          ...
          <div className="md:pl-8">
            <div className="sticky top-8">
              <h2 className="mb:text-center text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
                Book Your Deep<br />Cleaning Today
              </h2>
              <p className="text-gray-600 mb-8">
                Enter your location to find trusted cleaners in your area for deep cleaning service
              </p>
