  ...
  const reviews = [
    {
      ...
      location: "Fitzroy",
      rating: 5,
      review: "Booked a deep clean for my move-out and wow! They cleaned every corner, inside appliances, and even the windows. My bond was returned in full!",
      date: "1 week ago",
    ...
    },
    {
      ...
      location: "Prahran",
      rating: 5,
      review: "Needed a deep clean after renovations and they delivered beyond expectations. Deep cleaned everything including carpets and detailed scrubbing. Amazing work!",
      date: "2 weeks ago",
    ...
    },
    {
      ...
      location: "Brunswick",
      rating: 5,
      review: "Deep cleaning was exactly what I needed. They were thorough, professional, and left my home sparkling. Highly recommend for special occasions!",
      date: "3 weeks ago",
    ...
    },
    {
      ...
      location: "Richmond",
      rating: 5,
      review: "Incredible deep cleaning service! They tackled areas I didn't even know needed cleaning. Perfect for my pre-sale preparation. Exceeded all expectations!",
      date: "4 weeks ago",
    ...
    },
    {
      ...
      location: "Hawthorn",
      rating: 5,
      review: "Booked their premium deep clean package and it was worth every dollar. They cleaned inside every appliance and even the light fixtures. Absolutely spotless!",
      date: "5 weeks ago",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-6 md:mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1E3D8F] mb-4">
            What Our Clients Say About Our Deep Cleaning Services
          </h2>
