...
export default function AirbnbCleaningHero() {
  return (
    <section className="relative min-h-[500px] md:min-h-[400px] py-12 md:py-16">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Airbnb Cleaning Melbourne - Professional Short Stay Cleaning Service"
          fill
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4 mb-6 md:mb-8">
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full flex items-center">
              ...
              <span className="text-white text-sm font-medium">100% Satisfaction Guarantee</span>
            </div>
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full flex items-center">
              <Star className="w-5 h-5 text-yellow-400 mr-2" />
              <span className="text-white text-sm font-medium">Airbnb Host Approved</span>
            </div>
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full flex items-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 md:mb-6">
            Airbnb Cleaning Melbourne<br />
            <span className="text-3xl md:text-4xl font-medium">Professional Short Stay Cleaning Service</span>
          </h1>
          
          <p className="text-xl text-white/90 mb-6 md:mb-8 max-w-2xl">
            Expert Airbnb cleaning service in Melbourne. Professional turnover cleaning for short stay properties. 
            Trusted by hosts across Melbourne for reliable, same-day cleaning service.
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg mb-6 md:mb-8 inline-block">
            ...
            <div className="text-white/80 text-sm">Studio/1 Bedroom</div>
          </div>
