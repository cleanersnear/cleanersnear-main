          ...
          <div className="space-y-6 lg:space-y-8">
            <div className="space-y-3 lg:space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                Fast turnovers with hotel-standard presentation for your short-term rental. Professional cleaning service with linen change, restocking, and guest-ready presentation every time.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="relative h-[350px] sm:h-[400px] lg:h-[500px] xl:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Professional Airbnb cleaning service in Melbourne"
                fill
              ...
              {/* Overlay Card */}
              <div className="absolute bottom-3 left-3 right-3 sm:bottom-6 sm:right-6 sm:left-auto sm:w-auto bg-white/95 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-6 shadow-lg">
                 <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
                   <div className="hidden sm:flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600">Book in 60 seconds, same-day availability</p>
                    </div>
                  </div>
