      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
            No hidden fees, no surprises. Choose the general cleaning package that works best for your Melbourne home and requirements.
          </p>
        </div>
          ...
          {PRICING_PLANS.map((plan) => (
            ...
            >
              ...
              <div className={`p-6 lg:p-8 ${plan.popular ? 'pt-12' : ''}`}>
                ...
                <Link href={`/book?selectedServices=Regular%20Cleaning&frequency=${plan.name.includes('Weekly') ? 'Weekly' : 'Fortnightly'}`}>
                  <Button 
                    size="lg" 
                    className={`w-full ${
                      plan.popular 
