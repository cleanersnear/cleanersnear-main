...
export function CommercialCleaningHero() {
          ...
          <div className="space-y-6 lg:space-y-8">
            <div className="space-y-3 lg:space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                Professional cleaning for offices, retail spaces, and commercial properties. Flexible schedules, experienced teams, and reliable service to keep your business spotless and professional.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link href="/book?selectedServices=Commercial%20Cleaning">
                <Button 
                  size="lg" 
