export const getLocalBusinessSchema = () => {
  return {
    ...
    '@type': 'LocalBusiness',
    '@id': 'https://cleaningprofessionals.com.au/services/commercial-cleaning',
    name: 'Cleaning Professionals Melbourne - Commercial Cleaning Services',
    image: '/images/commercial-cleaning-melbourne.jpg',
    description: 'Professional commercial cleaning service in Melbourne. Specialized in thorough sanitization, detailed cleaning of all surfaces, and intensive cleaning using professional-grade equipment. Starting from $53.07/hour with minimum 3 hours booking.',
    url: 'https://cleaningprofessionals.com.au/services/commercial-cleaning',
