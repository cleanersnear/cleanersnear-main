          ...
          <div className="space-y-6 lg:space-y-8">
            <div className="space-y-3 lg:space-y-4">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
                Keep your home consistently clean with trusted local cleaners. Same cleaner each visit, flexible times, and simple online booking backed by our satisfaction guarantee.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="relative h-[350px] sm:h-[400px] lg:h-[500px] xl:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Professional house cleaning service in Melbourne"
                fill
